...
balance increases at the same growth rate. With the assumption that you don't make any additional deposits,
...
fun depositProfit(deposit: Int, rate: Int, threshold: Int): Int {
    var amount = deposit.toFloat()
    var year = 0
    while(amount < threshold){
        amount *= ((rate.toFloat() / 100) + 1)
        year++
    }
    return year
}
